...
window.APPS_DATA = [
  ...
  {"id":29,"name":"Fyzika pastelkou","platform":"Android","color":"#527dc4","cs":"Kresli a objevuj fyziku: mechanika, elektrické obvody, voda a olej. Neověřená alfa nyní obsahuje 152 misí ve 12 kapitolách včetně celé vlastní adaptace Atlasu. Nové mise zatím nemají ověřenou hratelnost a mohou vyžadovat opravy.\n\nVerze 0.1.2-android.4 · APK 12,0 MB · Android 9+, ARM64 a Vulkan. Vlastní pokusy, editor úloh, galerie a ukládání. Aplikace je česky, funguje offline, bez účtu a reklam. Snímky ukazují rozhraní předchozí verze.\n\nAPK nainstaluj přes stávající verzi bez odinstalování; tvoje data zůstanou zachována. Při první instalaci otevři APK ve správci souborů a na výzvu povol instalaci. Panel lze přesunout přes Nabídka → Umístění panelu.","en":"Draw and explore physics: mechanics, electrical circuits, water and oil. This unverified alpha now includes 152 missions in 12 chapters, including a complete original adaptation of the Atlas. The new missions have not been gameplay-tested and may need fixes.\n\nVersion 0.1.2-android.4 · 12.0 MB APK · Android 9+, ARM64 and Vulkan. Create your own experiments with a mission editor, gallery and saved progress. The app is in Czech and works offline, without accounts or ads. Screenshots show the previous version.\n\nInstall the APK over the existing version without uninstalling to keep your data. For a first installation, open the APK in your file manager and allow installation when prompted. Move the toolbar via Nabídka → Umístění panelu.","link":"/binaries/fyzika-pastelkou-0.1.2-android.4/Fyzika-pastelkou-0.1.2-android.4.apk","icon_url":"/icons/fyzika-pastelkou.png","screenshots":["/screenshots/fyzika-pastelkou/android-panel-bottom.png","/screenshots/fyzika-pastelkou/android-panel-top.png","/screenshots/fyzika-pastelkou/android-water.png","/screenshots/fyzika-pastelkou/android-chapter.png"],"sort":21,"release_stage":"alpha"},
];
