...
window.APPS_DATA = [
  ...
  {"id":29,"name":"Fyzika pastelkou","platform":"Android","color":"#527dc4","cs":"Kresli a objevuj fyziku: mechanika, elektrické obvody, voda a olej. Výběr úloh přes celou obrazovku, větší ovládání pro tablety a názorné ukázky nástrojů. Aplikace je česky a funguje offline, bez účtu a reklam.\n\nNově ve verzi 0.1.10: šest pastelek se stálými barvami a symboly — Pevná čára, Volné těleso, Drát, Lano, Voda a Olej. V úlohách, které to dovolují, nakreslíš vodu nebo olej tahem. Vidíš, kolik kapaliny zbývá, a můžeš použít Zpět, gumu i opakování pokusu. Hřebík a Guma mají vlastní místo vedle kreslení.\n\nUčitelský editor umí kapaliny také kreslit a určit dětem povolený druh, množství i oblast kreslení. Rozpracovanou úlohu lze obnovit, vyzkoušet a předat mezi zařízeními. Nápověda představuje jednotlivé pastelky; TalkBack vysvětluje i nedostupné nástroje.\n\nZůstávají opravy průchodu po kreslených čarách, otáčení připnutých dílů a vztlaku u dna nádrže z verze 0.1.9, pomoc v atlasových úlohách i vlastní mechanické a elektrické úlohy.\n\nVerze 0.1.10-android.12 · APK 12,8 MB · Android 9+, ARM64 a Vulkan. Alfa obsahuje 152 misí ve 12 kapitolách; 75 definic zatím čeká na ověření hratelnosti a může vyžadovat opravy. Nové prostředí bylo ověřované na Macu a Android emulátoru; fyzický tablet, pero/dlaň a zkoušení s dětmi ještě čekají.\n\nAktualizaci nainstaluj přes stávající aplikaci bez odinstalování. Při první instalaci otevři APK ve správci souborů a na výzvu povol instalaci. Polohu panelu vybereš přes Menu → Pro dospělé → Poloha ovládání. Editor je ve stejné dospělé části menu.","en":"Draw and explore physics: mechanics, electrical circuits, water and oil. A full-screen mission picker, larger tablet controls and visual tool tutorials. The app is in Czech and works offline, without accounts or ads.\n\nNew in 0.1.10: six crayons with consistent colours and symbols — Fixed line, Free body, Wire, Rope, Water and Oil. In tasks that allow it, draw water or oil with a stroke. See how much liquid remains and use Undo, the eraser or retry the experiment. Pin and Eraser have their own place alongside the drawing tools.\n\nThe teacher editor can also draw liquids and set the type, amount and drawing area allowed for children. Resume, try out and transfer a prepared task between devices. Tool help introduces each crayon; TalkBack also explains why a tool is unavailable.\n\nThe release retains the 0.1.9 fixes for collisions along drawn paths, rotation of pinned parts and buoyancy near the tank floor, as well as Atlas hints and custom mechanical and electrical tasks.\n\nVersion 0.1.10-android.12 · 12.8 MB APK · Android 9+, ARM64 and Vulkan. This alpha includes 152 missions in 12 chapters; 75 definitions still await gameplay verification and may need fixes. The new interface has been checked on Mac and in an Android emulator; physical tablet, pen/palm and child sessions remain pending.\n\nInstall over the existing app without uninstalling. For a first installation, open the APK in a file manager and allow installation when prompted. Choose the toolbar position through Menu → Pro dospělé → Poloha ovládání. The teacher editor is in the same adult section.","link":"/binaries/fyzika-pastelkou-0.1.10-android.12/Fyzika-pastelkou-0.1.10-android.12.apk","icon_url":"/icons/fyzika-pastelkou.png","screenshots":["/screenshots/fyzika-pastelkou-0.1.10/android-water.png","/screenshots/fyzika-pastelkou-0.1.3/android-missions.png","/screenshots/fyzika-pastelkou-0.1.3/android-play.png","/screenshots/fyzika-pastelkou-0.1.3/android-editor.png","/screenshots/fyzika-pastelkou-0.1.4/android-circuit.png"],"sort":21,"release_stage":"alpha"},
];
