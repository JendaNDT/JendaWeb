...
window.APPS_DATA = [
  ...
  {"cs":"Retro bombová arkáda s příběhem, místní kooperací a souboji v aréně. Pokládej bomby, sbírej bonusy a hraj s přáteli v místní síti (LAN). Zdarma, česky i anglicky.\n\nVerze 2.3.0 · Windows 10/11 x64 a Mac s Apple Silicon (M1 a novější). Pro Windows je k dispozici instalátor i portable EXE, pro Mac DMG i ZIP.\n\nNově ve verzi 2.3.0: pět ručních pozic pro ukládání i načítání. V pauze stiskni S, vyber pozici a potvrď Enterem; přepsání obsazené pozice se potvrzuje zvlášť. V nabídce Načíst hru uvidíš režim, kolo, skóre, čas uložení a náhled mapy. Automatická uložení mají vlastní záložku a ruční pozice nepřepisují.\n\nSpolehlivější ukládání: hra potvrzuje uložení až po zápisu na disk, používá stálé místo v uživatelských datech a udržuje záložní kopii. To platí i pro portable verzi; přesun EXE nemění umístění uložených her na daném počítači. Původní uložená hra se převede do první ruční pozice a ruční pozice zůstanou dostupné i po načtení nebo konci hry.\n\nVe hře zůstávají: týmový souboj 2 proti 2 se společným skóre, desetisekundové hlasování hráčů o prostředí další mapy a přehled, kolik ještě chybí do splnění úspěchu. Najdeš ho v nabídce Statistiky a úspěchy. Zůstává LAN, vyhledávání místností, vlastní turnajová pravidla i všechny dosavadní opravy.\n\nPro společnou hru připoj počítače do stejné místní sítě a na všech používej verzi 2.3.0. Příběh a místní hra fungují offline. Pohyb šipkami nebo WASD, bomba mezerníkem, pauza Esc, celá obrazovka F11.\n\nWindows: spusť instalátor, nebo stáhni a spusť portable EXE. Mac: otevři DMG a přetáhni BomberMan do Aplikací; ZIP obsahuje stejnou aplikaci. Mac balíčky jsou pro Apple Silicon.\n\nWindows vydání není digitálně podepsané a Mac není notarizovaný; systém může při spuštění zobrazit upozornění nebo aplikaci zablokovat. Běh na Windows a společná hra Windows–Mac na dvou fyzických počítačích zatím čekají na ověření.","en":"A retro bomb arcade game with a story, local co-op and arena battles. Place bombs, collect power-ups and play with friends on a local network (LAN). Free, in Czech and English.\n\nVersion 2.3.0 · Windows 10/11 x64 and Apple Silicon Mac (M1 or newer). Windows installer and portable EXE; Mac DMG and ZIP.\n\nNew in 2.3.0: five manual save and load slots. Press S while paused, choose a slot and confirm with Enter; overwriting an occupied slot requires a separate confirmation. Load Game shows the mode, stage, score, save time and a map preview. Autosaves have their own tab and never overwrite manual slots.\n\nMore reliable saves: the game confirms a save after writing it to disk, uses a stable location in your user data and keeps a backup. This also applies to the portable edition; moving the EXE does not change where saves are stored on that computer. Your existing save becomes manual slot one, and manual slots remain available after loading or game over.\n\nAlso included: 2v2 team battles with shared scoring, a ten-second player vote for the next arena theme, and achievement progress with the remaining goal. Open Statistics and Achievements to see your progress. LAN multiplayer, room discovery, custom tournament rules and all previous fixes are included.\n\nFor multiplayer, connect the computers to the same local network and use version 2.3.0 on all of them. Story and local play work offline. Move with arrows or WASD, place bombs with Space, pause with Esc and enter fullscreen with F11.\n\nWindows: run the installer, or download and run the portable EXE. Mac: open the DMG and drag BomberMan into Applications; the ZIP contains the same app. Mac packages require Apple Silicon.\n\nThe Windows release is unsigned and the Mac app is not notarized; the system may warn or block it at launch. Native Windows operation and Windows–Mac play on two physical computers still await verification.","id":31,"link":"[\"/binaries/bomberman-2.3.0/BomberMan-Setup-2.3.0.exe.part0\",\"/binaries/bomberman-2.3.0/BomberMan-Setup-2.3.0.exe.part1\",\"/binaries/bomberman-2.3.0/BomberMan-Setup-2.3.0.exe.part2\",\"/binaries/bomberman-2.3.0/BomberMan-Setup-2.3.0.exe.part3\",\"/binaries/bomberman-2.3.0/BomberMan-Setup-2.3.0.exe.part4\",\"/binaries/bomberman-2.3.0/BomberMan-Setup-2.3.0.exe.part5\"]","name":"BomberMan","sort":-2,"color":"#ffb52e","icon_url":"/icons/bomberman-2.0.5.png","platform":"Windows / macOS","screenshots":["/screenshots/bomberman-2.3.0/load-manual-cs.png","/screenshots/bomberman-2.3.0/save-overwrite-cs.png","/screenshots/bomberman-2.2.0/team-battle.png","/screenshots/bomberman-2.2.0/map-vote.png","/screenshots/bomberman-2.2.0/achievement-progress-cs.png"],"downloads":[{"url":"[\"/binaries/bomberman-2.3.0/BomberMan-Setup-2.3.0.exe.part0\",\"/binaries/bomberman-2.3.0/BomberMan-Setup-2.3.0.exe.part1\",\"/binaries/bomberman-2.3.0/BomberMan-Setup-2.3.0.exe.part2\",\"/binaries/bomberman-2.3.0/BomberMan-Setup-2.3.0.exe.part3\",\"/binaries/bomberman-2.3.0/BomberMan-Setup-2.3.0.exe.part4\",\"/binaries/bomberman-2.3.0/BomberMan-Setup-2.3.0.exe.part5\"]","primary":true,"label_cs":"Pro Windows","label_en":"For Windows","note_cs":"Instalátor · 105,2 MB","note_en":"Installer · 105.2 MB","version":"2.3.0","bytes":105202108},{"url":"[\"/binaries/bomberman-2.3.0/BomberMan-2.3.0-mac-arm64.dmg.part0\",\"/binaries/bomberman-2.3.0/BomberMan-2.3.0-mac-arm64.dmg.part1\",\"/binaries/bomberman-2.3.0/BomberMan-2.3.0-mac-arm64.dmg.part2\",\"/binaries/bomberman-2.3.0/BomberMan-2.3.0-mac-arm64.dmg.part3\",\"/binaries/bomberman-2.3.0/BomberMan-2.3.0-mac-arm64.dmg.part4\",\"/binaries/bomberman-2.3.0/BomberMan-2.3.0-mac-arm64.dmg.part5\"]","primary":true,"label_cs":"Pro Mac","label_en":"For Mac","note_cs":"Apple Silicon · 111,4 MB","note_en":"Apple Silicon · 111.4 MB","version":"2.3.0","bytes":111388764},{"url":"[\"/binaries/bomberman-2.3.0/BomberMan-2.3.0-portable.exe.part0\",\"/binaries/bomberman-2.3.0/BomberMan-2.3.0-portable.exe.part1\",\"/binaries/bomberman-2.3.0/BomberMan-2.3.0-portable.exe.part2\",\"/binaries/bomberman-2.3.0/BomberMan-2.3.0-portable.exe.part3\",\"/binaries/bomberman-2.3.0/BomberMan-2.3.0-portable.exe.part4\"]","primary":false,"label_cs":"Windows portable · 104,8 MB","label_en":"Windows portable · 104.8 MB","version":"2.3.0","bytes":104771766},{"url":"[\"/binaries/bomberman-2.3.0/BomberMan-2.3.0-mac-arm64.zip.part0\",\"/binaries/bomberman-2.3.0/BomberMan-2.3.0-mac-arm64.zip.part1\",\"/binaries/bomberman-2.3.0/BomberMan-2.3.0-mac-arm64.zip.part2\",\"/binaries/bomberman-2.3.0/BomberMan-2.3.0-mac-arm64.zip.part3\",\"/binaries/bomberman-2.3.0/BomberMan-2.3.0-mac-arm64.zip.part4\",\"/binaries/bomberman-2.3.0/BomberMan-2.3.0-mac-arm64.zip.part5\"]","primary":false,"label_cs":"Mac ZIP · 122,6 MB","label_en":"Mac ZIP · 122.6 MB","version":"2.3.0","bytes":122622530}]},
