...
window.APPS_DATA = [
  {"id": 33, "name": "Lost Signal", "platform": "Web", "color": "#d99735", "cs": "Logická plošinovka o třech hrdinech uvnitř rozbitého ovladače. Přepínej mezi Bramem, Rheou a K-9, kombinuj jejich schopnosti a dostaň celý tým k východu. Čeká tě 37 misí s příběhem a komiksovými scénami.\n\nHraj zdarma v prohlížeči na počítači nebo pomocí dotykového ovládání. Na telefonu otoč obrazovku na šířku. Hra je česky.\n\nWebová preview verze · první načtení přibližně 168 MB. Postup se ukládá v tomto prohlížeči. Fyzický iPhone zatím není ověřený.", "en": "A puzzle platformer about three heroes inside a broken remote control. Switch between Bram, Rhea and K-9, combine their abilities and lead the whole team to the exit. Explore 37 missions with a story and comic scenes.\n\nPlay free in your browser with a keyboard or touch controls. Turn your phone sideways. The game itself is in Czech.\n\nWeb preview · about 168 MB on first load. Progress is saved in this browser. A physical iPhone has not yet been tested.", "link": "/lost-signal/", "icon_url": "/lost-signal/releases/0.3.0-web.1/index.apple-touch-icon.png", "sort": 1, "screenshots": ["/screenshots/lost-signal-web.1/mission-01.png"]},
  ...
  {"id":29,"name":"Fyzika pastelkou","platform":"Android","color":"#527dc4","cs":"Digitální fyzikální sešit pro děti na základní škole, rodiče a učitele, ve kterém dětská kresba ožívá. Nakresli rampu, rozhýbej těleso, zapoj obvod nebo připrav pokus — a sleduj, co se stane. Změň svůj nápad a zkus to znovu.\n\nKresli rampy a podpěry, zkoumej pohyb a rovnováhu, propojuj elektrické součástky nebo veď vodu a olej korytem. Šest nástrojů má vlastní význam: Pevná čára, Volné těleso, Drát, Lano, Voda a Olej. Každá úloha určuje, které můžeš použít.\n\nPokus můžeš pozastavit, zpomalit a prohlédnout si záznam posledního průběhu. V editoru mohou rodiče a učitelé připravit vlastní zadání, scénu, cíle i nápovědu, úlohu vyzkoušet a předat souborem. Úpravy podporují historii Zpět/Znovu. Editor najdeš přes Menu → Pro dospělé → Editor úloh.\n\nNabídka Další pokusy · Experimentální přidává samostatné modely z optiky, magnetismu a zvuku, pokus s pístem a fyzikální výklady. Měň podmínky, pozoruj výsledek a objevuj meze modelu. Tyto pokusy jsou omezené; všechny fyzikální jevy mezi sebou nelze libovolně kombinovat.\n\nAplikace je česky a funguje místně a offline, bez účtů, cloudu, telemetrie a AI.\n\nNově ve verzi 0.1.23: Tlačítkem Znovu zopakuješ pokus jedním klepnutím. Kresba, tempo i nastavení zůstávají zachované; Upravit pokus tě vrátí k přípravě. Lištu můžeš ručně sbalit a získat víc prostoru pro kreslení. Při připojování drátu, lana nebo míření hřebíkem pomáhá lupa mimo místo pod prstem. Hřebík se připevní až při uvolnění. Ovládání funguje i po otočení obrazovky a se zvětšeným písmem.\n\nVeřejná Android alfa 0.1.23-android.25 · APK 14,3 MB · Android 9+, ARM64 a Vulkan. Obsah se dál vyvíjí; všechny úlohy ani vhodnost pro konkrétní věk a výuku ve třídě ještě nejsou plně ověřené. Přejímka na fyzickém tabletu, s perem a odmítáním dlaně i zkoušení s dětmi a učiteli zůstávají otevřené.\n\nPři první instalaci otevři APK ve správci souborů a na výzvu povol instalaci. Aktualizaci nainstaluj přes stávající aplikaci bez odinstalování.","en":"A digital physics notebook for primary school children, parents and teachers, where children's drawings come to life. Draw a ramp, set an object in motion, connect a circuit or prepare an experiment — and see what happens. Change your idea and try again.\n\nDraw ramps and supports, explore motion and balance, connect electrical components or guide water and oil through a channel. Six tools have distinct roles: Fixed Line, Free Body, Wire, Rope, Water and Oil. Each lesson determines which tools you can use.\n\nPause or slow down an experiment and review the recording of your last attempt. In the editor, parents and teachers can prepare their own instructions, scene, goals and hints, try the lesson and share it as a file. Editing supports undo/redo history. Find the editor under Menu → Pro dospělé → Editor úloh.\n\nDalší pokusy · Experimentální offers separate models for optics, magnetism and sound, a piston experiment and physics explanations. Change the conditions, observe the result and explore the limits of each model. These experiments have a limited scope; their physics cannot all be freely combined.\n\nThe app is in Czech and runs locally and offline, without accounts, cloud services, telemetry or AI.\n\nNew in version 0.1.23: Repeat an experiment with one tap on Znovu. Your drawing, speed and settings are preserved; Upravit pokus returns to editing. Collapse the toolbar manually to make more room for drawing. A magnifier away from your finger helps connect wires and ropes or aim a pin. The pin attaches when you release. The controls also work after rotation and with larger text.\n\nPublic Android alpha 0.1.23-android.25 · 14.3 MB APK · Android 9+, ARM64 and Vulkan. The content is still evolving; not every lesson or its suitability for a particular age or classroom use has been fully verified. Checks on physical tablets, pen input and palm rejection, and sessions with children and teachers remain pending.\n\nFor a first installation, open the APK in a file manager and allow installation when prompted. Install updates over the existing app without uninstalling it.","link":"/binaries/fyzika-pastelkou-0.1.23-android.25/Fyzika-pastelkou-0.1.23-android.25.apk","icon_url":"/icons/fyzika-pastelkou.png","screenshots":["/screenshots/fyzika-pastelkou-0.1.23/experiment.png","/screenshots/fyzika-pastelkou-0.1.23/water-oil.png","/screenshots/fyzika-pastelkou-0.1.23/magnifier.png","/screenshots/fyzika-pastelkou-0.1.23/repeat.png","/screenshots/fyzika-pastelkou-0.1.23/editor.png"],"sort":21,"release_stage":"alpha"},
];
