...
window.APPS_DATA = [
  ...
  {"cs":"Retro bombová arkáda s příběhem, místní kooperací a souboji v aréně. Pokládej bomby, sbírej bonusy a hraj s přáteli v místní síti (LAN). Zdarma, česky i anglicky.\n\nVerze 2.3.2 · Windows 10/11 x64 a Mac s Apple Silicon (M1 a novější). Pro Windows je k dispozici instalátor i portable EXE, pro Mac DMG i ZIP.\n\nNově ve verzi 2.3.2: obtížnost nové hry vybereš přímo nad seznamem místních herních režimů. Šipkami ←/→ přepneš mezi Snadná, Normální a Těžká; krátký popis ti pomůže s první volbou. Načtené hry si zachovají svou obtížnost a Denní výzva zůstává na normální.\n\nNově ve verzi 2.3.1: nepřátele na lehké a střední obtížnosti snáz zasáhneš bombami — reagují na cizí bomby později. Těžká obtížnost se nemění.\n\nNově ve verzi 2.3.0: pět ručních pozic pro ukládání i načítání. V pauze stiskni S, vyber pozici a potvrď Enterem; přepsání obsazené pozice se potvrzuje zvlášť. V nabídce Načíst hru uvidíš režim, kolo, skóre, čas uložení a náhled mapy. Automatická uložení mají vlastní záložku a ruční pozice nepřepisují.\n\nSpolehlivější ukládání: hra potvrzuje uložení až po zápisu na disk, používá stálé místo v uživatelských datech a udržuje záložní kopii. To platí i pro portable verzi; přesun EXE nemění umístění uložených her na daném počítači. Původní uložená hra se převede do první ruční pozice a ruční pozice zůstanou dostupné i po načtení nebo konci hry.\n\nVe hře zůstávají: týmový souboj 2 proti 2 se společným skóre, desetisekundové hlasování hráčů o prostředí další mapy a přehled, kolik ještě chybí do splnění úspěchu. Najdeš ho v nabídce Statistiky a úspěchy. Zůstává LAN, vyhledávání místností, vlastní turnajová pravidla i všechny dosavadní opravy.\n\nPro společnou hru připoj počítače do stejné místní sítě a na všech používej verzi 2.3.2. Příběh a místní hra fungují offline. Pohyb šipkami nebo WASD, bomba mezerníkem, pauza Esc, celá obrazovka F11.\n\nWindows: spusť instalátor, nebo stáhni a spusť portable EXE. Mac: otevři DMG a přetáhni BomberMan do Aplikací; ZIP obsahuje stejnou aplikaci. Mac balíčky jsou pro Apple Silicon.\n\nWindows vydání není digitálně podepsané a Mac není notarizovaný; systém může při spuštění zobrazit upozornění nebo aplikaci zablokovat. Běh na Windows a společná hra Windows–Mac na dvou fyzických počítačích zatím čekají na ověření.","en":"A retro bomb arcade game with a story, local co-op and arena battles. Place bombs, collect power-ups and play with friends on a local network (LAN). Free, in Czech and English.\n\nVersion 2.3.2 · Windows 10/11 x64 and Apple Silicon Mac (M1 or newer). Windows installer and portable EXE; Mac DMG and ZIP.\n\nNew in 2.3.2: choose the difficulty for a new game directly above the local game modes. Use ←/→ to switch between Easy, Normal and Hard; a short description helps you choose before your first game. Loaded games keep their own difficulty, and the Daily Challenge stays on Normal.\n\nNew in 2.3.1: enemies on Easy and Normal are easier to hit with bombs because they react to bombs placed by others later. Hard difficulty is unchanged.\n\nNew in 2.3.0: five manual save and load slots. Press S while paused, choose a slot and confirm with Enter; overwriting an occupied slot requires a separate confirmation. Load Game shows the mode, stage, score, save time and a map preview. Autosaves have their own tab and never overwrite manual slots.\n\nMore reliable saves: the game confirms a save after writing it to disk, uses a stable location in your user data and keeps a backup. This also applies to the portable edition; moving the EXE does not change where saves are stored on that computer. Your existing save becomes manual slot one, and manual slots remain available after loading or game over.\n\nAlso included: 2v2 team battles with shared scoring, a ten-second player vote for the next arena theme, and achievement progress with the remaining goal. Open Statistics and Achievements to see your progress. LAN multiplayer, room discovery, custom tournament rules and all previous fixes are included.\n\nFor multiplayer, connect the computers to the same local network and use version 2.3.2 on all of them. Story and local play work offline. Move with arrows or WASD, place bombs with Space, pause with Esc and enter fullscreen with F11.\n\nWindows: run the installer, or download and run the portable EXE. Mac: open the DMG and drag BomberMan into Applications; the ZIP contains the same app. Mac packages require Apple Silicon.\n\nThe Windows release is unsigned and the Mac app is not notarized; the system may warn or block it at launch. Native Windows operation and Windows–Mac play on two physical computers still await verification.","id":31,"link":"[\"/binaries/bomberman-2.3.2/BomberMan-Setup-2.3.2.exe.part0\",\"/binaries/bomberman-2.3.2/BomberMan-Setup-2.3.2.exe.part1\",\"/binaries/bomberman-2.3.2/BomberMan-Setup-2.3.2.exe.part2\",\"/binaries/bomberman-2.3.2/BomberMan-Setup-2.3.2.exe.part3\",\"/binaries/bomberman-2.3.2/BomberMan-Setup-2.3.2.exe.part4\",\"/binaries/bomberman-2.3.2/BomberMan-Setup-2.3.2.exe.part5\"]","name":"BomberMan","sort":-2,"color":"#ffb52e","icon_url":"/icons/bomberman-2.0.5.png","platform":"Windows / macOS","screenshots":["/screenshots/bomberman-2.3.2/difficulty-menu-cs.png","/screenshots/bomberman-2.3.0/load-manual-cs.png","/screenshots/bomberman-2.3.0/save-overwrite-cs.png","/screenshots/bomberman-2.2.0/team-battle.png","/screenshots/bomberman-2.2.0/map-vote.png","/screenshots/bomberman-2.2.0/achievement-progress-cs.png"],"downloads":[{"url":"[\"/binaries/bomberman-2.3.2/BomberMan-Setup-2.3.2.exe.part0\",\"/binaries/bomberman-2.3.2/BomberMan-Setup-2.3.2.exe.part1\",\"/binaries/bomberman-2.3.2/BomberMan-Setup-2.3.2.exe.part2\",\"/binaries/bomberman-2.3.2/BomberMan-Setup-2.3.2.exe.part3\",\"/binaries/bomberman-2.3.2/BomberMan-Setup-2.3.2.exe.part4\",\"/binaries/bomberman-2.3.2/BomberMan-Setup-2.3.2.exe.part5\"]","primary":true,"label_cs":"Pro Windows","label_en":"For Windows","note_cs":"Instalátor · 105,2 MB","note_en":"Installer · 105.2 MB","version":"2.3.2","bytes":105202394},{"url":"[\"/binaries/bomberman-2.3.2/BomberMan-2.3.2-mac-arm64.dmg.part0\",\"/binaries/bomberman-2.3.2/BomberMan-2.3.2-mac-arm64.dmg.part1\",\"/binaries/bomberman-2.3.2/BomberMan-2.3.2-mac-arm64.dmg.part2\",\"/binaries/bomberman-2.3.2/BomberMan-2.3.2-mac-arm64.dmg.part3\",\"/binaries/bomberman-2.3.2/BomberMan-2.3.2-mac-arm64.dmg.part4\",\"/binaries/bomberman-2.3.2/BomberMan-2.3.2-mac-arm64.dmg.part5\"]","primary":true,"label_cs":"Pro Mac","label_en":"For Mac","note_cs":"Apple Silicon · 111,4 MB","note_en":"Apple Silicon · 111.4 MB","version":"2.3.2","bytes":111388919},{"url":"[\"/binaries/bomberman-2.3.2/BomberMan-2.3.2-portable.exe.part0\",\"/binaries/bomberman-2.3.2/BomberMan-2.3.2-portable.exe.part1\",\"/binaries/bomberman-2.3.2/BomberMan-2.3.2-portable.exe.part2\",\"/binaries/bomberman-2.3.2/BomberMan-2.3.2-portable.exe.part3\",\"/binaries/bomberman-2.3.2/BomberMan-2.3.2-portable.exe.part4\"]","primary":false,"label_cs":"Windows portable · 104,8 MB","label_en":"Windows portable · 104.8 MB","version":"2.3.2","bytes":104772033},{"url":"[\"/binaries/bomberman-2.3.2/BomberMan-2.3.2-mac-arm64.zip.part0\",\"/binaries/bomberman-2.3.2/BomberMan-2.3.2-mac-arm64.zip.part1\",\"/binaries/bomberman-2.3.2/BomberMan-2.3.2-mac-arm64.zip.part2\",\"/binaries/bomberman-2.3.2/BomberMan-2.3.2-mac-arm64.zip.part3\",\"/binaries/bomberman-2.3.2/BomberMan-2.3.2-mac-arm64.zip.part4\",\"/binaries/bomberman-2.3.2/BomberMan-2.3.2-mac-arm64.zip.part5\"]","primary":false,"label_cs":"Mac ZIP · 122,6 MB","label_en":"Mac ZIP · 122.6 MB","version":"2.3.2","bytes":122623023}]},
  ...
  {"id":29,"name":"Fyzika pastelkou","platform":"Android","color":"#527dc4","cs":"Kresli a objevuj fyziku: mechanika, elektrické obvody, voda a olej. Aplikace je česky a funguje offline, bez účtu a reklam. Šest pastelek rozlišuje pevnou čáru, volné těleso, drát, lano, vodu a olej; kapaliny kreslíš přímo tahem.\n\nNově ve verzi 0.1.17: správné barvy kresby při přepínání papíru a tabule, čitelnější zásoba pastelky včetně prázdné části a více místa pro úlohu pod ovládacími lištami. Ruční posun a přiblížení scény se zachovají.\n\nOd verze 0.1.16: přehlednější nástroje a ovládání pokusu, místní úpravy vybraného tahu včetně otáčení a jasně pojmenované vrácení/obnovení úprav. Záznam posledního pokusu můžeš přehrát, zpomalit nebo procházet po snímcích. Formuláře učitelského editoru nechávají scénu viditelnou a fungují i s větším textem. Přesnější ukazatele inkoustu, vody a oleje a volitelná, ve výchozím stavu vypnutá haptika doplňují ovládání.\n\nOd verze 0.1.15: Menu → Další pokusy nabídne 72 experimentálních úloh v pěti obrázkových skupinách. Při nastavování pokusu zůstává scéna viditelná; připravený pokus spustíš tlačítkem Spustit. Měření mají čitelné jednotky a dotykové rady usnadní ovládání, které počítá i s větším písmem.\n\nOd verze 0.1.14: při tvorbě zadání učitel nakreslí vlastní pevnou čáru nebo volné těleso. Zpřesnění kresby má porovnávací náhled, potvrzení i vrácení změny. Počáteční hodnoty laboratorních pokusů nastavuje nezávisle na tom, co smí měnit dítě; může přidávat a odebírat ovládání i zvukové panely. Optika doplňuje stínítko, stínicí překážky a přímý výběr skupin nastavení. Historie Zpět/Znovu se uchová i po restartu. Kreslená zadání a návrhy s historií vyžadují tuto nebo novější verzi i na přijímajícím zařízení.\n\nOd verze 0.1.13: Menu → Nástroje → Zpřesnit tah pomůže narovnat téměř rovné části a zjemnit drobné roztřesení kresby. Nejprve porovnáš původní tah a návrh, potom úpravu potvrdíš nebo ponecháš původní. Výrazné rohy a konce zůstávají zachované; nejde o převod na předem dané tvary. Změnu lze vrátit. Pomocník upraví kresbu i fyzické těleso a uloží potvrzenou dráhu. Funguje pro pevnou čáru a volné těleso v přípravě i zkoušce úlohy. Připojené tahy, dráty, lana a kapaliny nemění. Zpřesněná kresba vyžaduje tuto verzi také na přijímajícím zařízení.\n\nEditor má pojmenované volby místo číselných kódů, úhly ve stupních a přesné vysvětlení, proč zatím nelze úlohu předat.\n\nOd verze 0.1.12: učitel sestaví vlastní optickou soustavu ze zrcadel, tenkých a fyzických čoček. Přidává, kopíruje a odebírá prvky, nastavuje jejich polohu, tvar a materiál i povolené změny dítěte. Úpravy lze vracet a rozpracovaná soustava se uchová.\n\nVlastní laboratorní úlohy lze po vítězné zkoušce připravit k hraní a předat dětem souborem úloh. Při vydání i importu aplikace řešení znovu ověří; u pístu zachová také časování ohřevu. Předává původní zadání, dětský profil zůstává na zařízení. Nové laboratorní balíčky vyžadují tuto verzi i na přijímajícím zařízení.\n\nZůstává pokus s ohřívaným pístem, 27 úloh magnetismu a zvuku, 15 optických pokusů s lomem, čočkami, obrazem, lupou a dalekohledem a 29 úloh „Jak to doopravdy funguje“: obzor, Měsíc, zatmění, roční období, pád těles, tíha, družice, teplo, proud a Einsteinův výtah. Měň podmínku, sleduj výsledek a přečti si vysvětlení včetně mezí modelu.\n\nVerze 0.1.17-android.19 · APK 14,3 MB · Android 9+, ARM64 a Vulkan. Stále jde o alfu: běžný Atlas obsahuje 152 definic ve 12 kapitolách, z nichž 75 čeká na ověření hratelnosti. Nové laboratoře jsou samostatné. Přenos a obnova prošly testy na Android emulátoru; aktualizace, zachování dat a vybrané ovládání editoru byly ověřeny i v podepsané aplikaci. Fyzický tablet, pero/dlaň a zkoušení s dětmi ještě čekají.\n\nAktualizaci nainstaluj přes stávající aplikaci bez odinstalování. Při první instalaci otevři APK ve správci souborů a na výzvu povol instalaci. Učitelský editor najdeš přes Menu → Pro dospělé.","en":"Draw and explore physics: mechanics, electrical circuits, water and oil. The app is in Czech and works offline, without accounts or ads. Six crayons distinguish fixed lines, free bodies, wire, rope, water and oil; draw liquids directly with a stroke.\n\nNew in version 0.1.17: consistent drawing colors when switching between paper and chalkboard, clearer crayon supply including the empty part, and more room for each lesson below the controls. Manual panning and zooming are preserved.\n\nSince 0.1.16: clearer tools and experiment controls, local editing of the selected stroke including rotation, and explicit undo/redo labels. Replay the last attempt, slow it down or step through recorded frames. Teacher editor forms keep the scene visible and support larger text. More precise ink, water and oil indicators and optional haptics, off by default, complete the controls.\n\nNew in 0.1.15: Menu → Další pokusy brings together 72 experimental lessons in five illustrated groups. The scene stays visible while you adjust an experiment; start it when ready with Spustit. Measurements have readable units, and touch hints make the controls easier to use, including with larger text.\n\nSince 0.1.14: teachers can draw their own fixed lines and free bodies directly into a task. Refinement has a comparison preview, explicit confirmation and undo. Laboratory initial values can be edited independently of the controls allowed for children; controls and sound panels can be added or removed. Optics adds a screen, blocking obstacles and direct navigation between settings groups. Undo/redo history survives restarting. Drawn tasks and drafts with history require this version or newer on the receiving device too.\n\nSince 0.1.13: Menu → Nástroje → Zpřesnit tah helps straighten nearly straight sections and reduce small drawing wobbles. Compare the original stroke and proposal, then confirm or keep the original. Distinct corners and endpoints are preserved; this does not convert drawings to predefined shapes. Changes can be undone. The helper updates both the drawing and its physical body and saves the accepted path. It supports fixed lines and free bodies during preparation and lesson trials. Attached strokes, wires, ropes and liquids stay unchanged. Refined drawings require this version on the receiving device too.\n\nThe editor adds named choices instead of numeric codes, angles in degrees and specific explanations when a lesson cannot yet be shared.\n\nSince 0.1.12: teachers can compose their own optical systems using mirrors, thin lenses and physical lenses. Add, copy and remove elements, adjust position, shape and material, and choose the changes children may make. Editing supports undo and recovery of unfinished systems.\n\nAfter a winning trial, custom laboratory lessons can be prepared for play and shared as a lesson file. The app verifies the solution again during publication and import, including heater timing for piston lessons. Children receive the original task; their profile stays on their device. New laboratory packs require this version on the receiving device too.\n\nThe release retains the heated piston, 27 magnetism and sound lessons, 15 optics experiments with refraction, lenses, images, a magnifier and telescope, and 29 “Jak to doopravdy funguje” experiments covering the horizon, Moon, eclipses, seasons, falling objects, weight, satellites, heat, current and the Einstein elevator. Change a condition, observe the result and read the explanation and model limitations.\n\nVersion 0.1.17-android.19 · 14.3 MB APK · Android 9+, ARM64 and Vulkan. Still an alpha: the regular Atlas has 152 definitions in 12 chapters, with 75 awaiting gameplay verification. The laboratories are separate. Transfer and recovery passed tests on an Android emulator; updating, data preservation and selected editor controls were also checked in the signed app. Physical tablet, pen/palm and child sessions remain pending.\n\nInstall over the existing app without uninstalling. For a first installation, open the APK in a file manager and allow installation when prompted. The teacher editor is under Menu → Pro dospělé.","link":"/binaries/fyzika-pastelkou-0.1.17-android.19/Fyzika-pastelkou-0.1.17-android.19.apk","icon_url":"/icons/fyzika-pastelkou.png","screenshots":["/screenshots/fyzika-pastelkou-0.1.17/android-rendering.png","/screenshots/fyzika-pastelkou-0.1.16/android-replay.png","/screenshots/fyzika-pastelkou-0.1.15/android-groups.png","/screenshots/fyzika-pastelkou-0.1.15/android-panel1.png","/screenshots/fyzika-pastelkou-0.1.14/android-teacher-drawing.png","/screenshots/fyzika-pastelkou-0.1.13/android-refinement.png","/screenshots/fyzika-pastelkou-0.1.12/android-optical-editor.png","/screenshots/fyzika-pastelkou-0.1.11/android-horizon.png"],"sort":21,"release_stage":"alpha"},
];
