...
window.APPS_DATA = [
  ...
  {"cs":"Retro bombová arkáda s příběhem, místní kooperací a souboji v aréně. Pokládej bomby, sbírej bonusy a hraj s přáteli v místní síti (LAN). Zdarma, česky i anglicky.\n\nVerze 2.1.1 · Windows 10/11 x64 a Mac s Apple Silicon (M1 a novější). Pro Windows je k dispozici instalátor i portable EXE, pro Mac DMG i ZIP.\n\nOproti 2.0.6 přibyla hra po LAN, vyhledávání místností a turnaje s vlastními pravidly. Nejnovější opravy zlepšují stabilitu síťové hry, odchod z kooperace, snadnou AI, ukládání odznaků a ovládání oken. Licence knihoven najdeš přímo ve hře.\n\nPro společnou hru připoj počítače do stejné místní sítě a na všech používej verzi 2.1.1. Příběh a místní hra fungují offline. Pohyb šipkami nebo WASD, bomba mezerníkem, pauza Esc, celá obrazovka F11.\n\nWindows: spusť instalátor, nebo stáhni a spusť portable EXE. Mac: otevři DMG a přetáhni BomberMan do Aplikací; ZIP obsahuje stejnou aplikaci. Mac balíčky jsou pro Apple Silicon.\n\nWindows vydání není digitálně podepsané a Mac není notarizovaný; systém může při spuštění zobrazit upozornění nebo aplikaci zablokovat. Běh na Windows a společná hra Windows–Mac na dvou fyzických počítačích zatím čekají na ověření.","en":"A retro bomb arcade game with a story, local co-op and arena battles. Place bombs, collect power-ups and play with friends on a local network (LAN). Free, in Czech and English.\n\nVersion 2.1.1 · Windows 10/11 x64 and Apple Silicon Mac (M1 or newer). Windows installer and portable EXE; Mac DMG and ZIP.\n\nSince 2.0.6: LAN multiplayer, room discovery and tournaments with custom rules. The latest fixes improve network stability, leaving co-op, easy AI, badge saving and window controls. Library licenses are available in the game.\n\nFor multiplayer, connect the computers to the same local network and use version 2.1.1 on all of them. Story and local play work offline. Move with arrows or WASD, place bombs with Space, pause with Esc and enter fullscreen with F11.\n\nWindows: run the installer, or download and run the portable EXE. Mac: open the DMG and drag BomberMan into Applications; the ZIP contains the same app. Mac packages require Apple Silicon.\n\nThe Windows release is unsigned and the Mac app is not notarized; the system may warn or block it at launch. Native Windows operation and Windows–Mac play on two physical computers still await verification.","id":31,"link":"/binaries/bomberman-2.1.1/BomberMan-Setup-2.1.1.exe","name":"BomberMan","sort":-2,"color":"#ffb52e","icon_url":"/icons/bomberman-2.0.5.png","platform":"Windows / macOS","screenshots":["/screenshots/bomberman-2.1.1/battle.png","/screenshots/bomberman-2.1.1/story.png"],"downloads":[{"url":"/binaries/bomberman-2.1.1/BomberMan-Setup-2.1.1.exe","primary":true,"label_cs":"Pro Windows","label_en":"For Windows","note_cs":"Instalátor · 105,2 MB","note_en":"Installer · 105.2 MB","version":"2.1.1"},{"url":"/binaries/bomberman-2.1.1/BomberMan-2.1.1-mac-arm64.dmg","primary":true,"label_cs":"Pro Mac","label_en":"For Mac","note_cs":"Apple Silicon · 111,4 MB","note_en":"Apple Silicon · 111.4 MB","version":"2.1.1"},{"url":"/binaries/bomberman-2.1.1/BomberMan-2.1.1-portable.exe","primary":false,"label_cs":"Windows portable · 104,8 MB","label_en":"Windows portable · 104.8 MB","version":"2.1.1"},{"url":"/binaries/bomberman-2.1.1/BomberMan-2.1.1-mac-arm64.zip","primary":false,"label_cs":"Mac ZIP · 122,6 MB","label_en":"Mac ZIP · 122.6 MB","version":"2.1.1"}]},
