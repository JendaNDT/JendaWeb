...
window.APPS_DATA = [
  {"id":29,"name":"Fyzika pastelkou","platform":"Android","color":"#527dc4","cs":"Kresli a objevuj fyziku v 64 misích: mechanika, elektrické obvody, voda a olej. Vlastní pokusy, editor úloh, galerie a ukládání. Aplikace je česky, funguje offline, bez účtu a reklam.\n\nVerze 0.1.1-android.2 · APK 11 MB · Android 9+, ARM64 a Vulkan. Nově můžeš panel přesunout nahoru nebo dolů: Nabídka → Umístění panelu. Volba se pamatuje i po zavření aplikace.\n\nAPK nainstaluj přes stávající verzi bez odinstalování; tvoje data zůstanou zachována. Při první instalaci otevři APK ve správci souborů a na výzvu povol instalaci.","en":"Draw and explore physics in 64 missions: mechanics, electrical circuits, water and oil. Create your own experiments with a mission editor, gallery and saved progress. The app is in Czech and works offline, without accounts or ads.\n\nVersion 0.1.1-android.2 · 11 MB APK · Android 9+, ARM64 and Vulkan. You can now move the toolbar to the top or bottom via Nabídka → Umístění panelu. Your choice is saved across restarts.\n\nInstall the APK over the existing version without uninstalling to keep your data. For a first installation, open the APK in your file manager and allow installation when prompted.","link":"/binaries/fyzika-pastelkou-0.1.1-android.2/Fyzika-pastelkou-0.1.1-android.2.apk","icon_url":"/icons/fyzika-pastelkou.png","screenshots":["/screenshots/fyzika-pastelkou/android-panel-bottom.png","/screenshots/fyzika-pastelkou/android-panel-top.png","/screenshots/fyzika-pastelkou/android-water.png"],"sort":0},
