...
window.APPS_DATA = [
  {"id":29,"name":"Fyzika pastelkou","platform":"Android","color":"#527dc4","cs":"Kresli a objevuj fyziku v 64 misích: mechanika, elektrické obvody, voda a olej. Vlastní pokusy, editor úloh, galerie a ukládání. Aplikace je česky, funguje offline, bez účtu a reklam.\n\nPrvní verze 0.1.1-android.1 · APK 11 MB · Android 9+, ARM64 a Vulkan. Pro tablety; na telefonu doporučuji polohu na šířku a S Pen. Zatím ověřeno v emulátoru, test na skutečném zařízení čeká.\n\nPo stažení otevři APK ve správci souborů a na výzvu povol instalaci. Před odinstalováním exportuj své výkresy a profil.","en":"Draw and explore physics in 64 missions: mechanics, electrical circuits, water and oil. Create your own experiments with a mission editor, gallery and saved progress. The app is in Czech and works offline, without accounts or ads.\n\nFirst release 0.1.1-android.1 · 11 MB APK · Android 9+, ARM64 and Vulkan. Designed for tablets; landscape mode and S Pen are recommended on phones. Tested in an emulator; physical-device testing is still pending.\n\nAfter downloading, open the APK in your file manager and allow installation when prompted. Export your drawings and profile before uninstalling.","link":"/binaries/fyzika-pastelkou-0.1.1-android.1/Fyzika-pastelkou-0.1.1-android.1.apk","icon_url":"/icons/fyzika-pastelkou.png","screenshots":["/screenshots/fyzika-pastelkou/android-water.png"],"sort":0},
