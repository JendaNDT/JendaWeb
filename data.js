...
window.APPS_DATA = [
  ...
  {"id":29,"name":"Fyzika pastelkou","platform":"Android","color":"#527dc4","cs":"Kresli a objevuj fyziku: mechanika, elektrické obvody, voda a olej. Aplikace je česky a funguje offline, bez účtu a reklam. Šest pastelek rozlišuje pevnou čáru, volné těleso, drát, lano, vodu a olej; kapaliny kreslíš přímo tahem.\n\nNově ve verzi 0.1.11: pokus s ohřívaným pístem, 27 úloh magnetismu a zvuku a 15 optických pokusů. Vyzkoušej odraz a lom světla, úplný odraz, čočky s měnitelným tvarem a materiálem, vznik obrazu, lupu i dalekohled.\n\nNabídka „Jak to doopravdy funguje“ přidává 29 ovladatelných pokusů: loď za obzorem, fáze a zatmění Měsíce, roční období, pád těles, tíhu, družice, tepelný kontakt, proud a dobrovolný Einsteinův výtah. Měň podmínku, sleduj výsledek a přečti si vysvětlení včetně mezí modelu. Pokusy najdeš přímo v Menu; přípravu můžeš upravovat, spouštět a obnovovat. Učitelský editor umožňuje vlastní varianty.\n\nZůstává výběr běžných úloh přes celou obrazovku, větší tabletové ovládání, názorná nápověda, kreslení kapalin, historie a přenos vlastní práce mezi kompatibilními zařízeními.\n\nVerze 0.1.11-android.13 · APK 14,0 MB · Android 9+, ARM64 a Vulkan. Stále jde o alfu: běžný Atlas obsahuje 152 definic ve 12 kapitolách, z nichž 75 čeká na ověření hratelnosti. Nové laboratoře jsou samostatné. Aktualizace, zachování dat a vybrané nové pokusy byly ověřené na Android emulátoru; fyzický tablet, pero/dlaň a zkoušení s dětmi ještě čekají.\n\nAktualizaci nainstaluj přes stávající aplikaci bez odinstalování. Při první instalaci otevři APK ve správci souborů a na výzvu povol instalaci. Polohu panelu a učitelský editor najdeš přes Menu → Pro dospělé.","en":"Draw and explore physics: mechanics, electrical circuits, water and oil. The app is in Czech and works offline, without accounts or ads. Six crayons distinguish fixed lines, free bodies, wire, rope, water and oil; draw liquids directly with a stroke.\n\nNew in 0.1.11: a heated piston experiment, 27 magnetism and sound lessons, and 15 optics experiments. Explore reflection, refraction, total internal reflection, lenses with adjustable shape and material, image formation, a magnifier and a telescope.\n\nThe “Jak to doopravdy funguje” menu adds 29 interactive experiments covering ships beyond the horizon, lunar phases and eclipses, seasons, falling objects, weight, satellites, thermal contact, current and an optional Einstein elevator. Change a condition, observe the result and read the explanation and model limitations. Find experiments in Menu; adjust, run and restore their preparation. The teacher editor supports custom variants.\n\nThe release retains the full-screen regular mission picker, larger tablet controls, visual help, drawn liquids, history and transfer of custom work between compatible devices.\n\nVersion 0.1.11-android.13 · 14.0 MB APK · Android 9+, ARM64 and Vulkan. Still an alpha: the regular Atlas has 152 definitions in 12 chapters, with 75 awaiting gameplay verification. The new laboratories are separate. Updating, data preservation and selected new experiments were checked in an Android emulator; physical tablet, pen/palm and child sessions remain pending.\n\nInstall over the existing app without uninstalling. For a first installation, open the APK in a file manager and allow installation when prompted. Toolbar placement and the teacher editor are under Menu → Pro dospělé.","link":"/binaries/fyzika-pastelkou-0.1.11-android.13/Fyzika-pastelkou-0.1.11-android.13.apk","icon_url":"/icons/fyzika-pastelkou.png","screenshots":["/screenshots/fyzika-pastelkou-0.1.11/android-horizon.png","/screenshots/fyzika-pastelkou-0.1.10/android-water.png","/screenshots/fyzika-pastelkou-0.1.3/android-missions.png","/screenshots/fyzika-pastelkou-0.1.3/android-play.png","/screenshots/fyzika-pastelkou-0.1.3/android-editor.png"],"sort":21,"release_stage":"alpha"},
];
