...
window.APPS_DATA = [
  ...
  {"id":31,"name":"BomberMan","platform":"Windows","color":"#ffb52e","cs":"Retro bombová arkáda s příběhovým režimem, místní kooperací a souboji v aréně. Pokládej bomby, sbírej bonusy a najdi cestu ven. Česky i anglicky, funguje offline.\n\nVerze 2.0.6 · Windows 10/11, 64 bitů · EXE 104,2 MB. Přenosná verze bez instalace: stáhni soubor a spusť jej. Pohyb šipkami nebo WASD, bomba mezerníkem, pauza Esc, celá obrazovka F11.\n\nNově pestřejší retro hudba s delšími melodiemi, druhým hlasem a obměnami doprovodu. Průvodce v Nastavení → Ovládání tě provede nastavením všech šesti kláves; Esc rozpracované změny zruší. Jednotlivé klávesy lze měnit i samostatně.\n\nVylepšené zobrazení na QHD a 4K, mírnější posily po vypršení času a ukončení aplikace přímo z menu. Scanlines jsou ve výchozím stavu vypnuté a lze je zapnout v nastavení.\n\nToto vydání zatím není digitálně podepsané. Windows může při spuštění zobrazit upozornění nebo aplikaci zablokovat.","en":"A retro bomb arcade game with a story mode, local co-op and arena battles. Place bombs, collect power-ups and find the exit. Available in Czech and English; works offline.\n\nVersion 2.0.6 · Windows 10/11, 64-bit · 104.2 MB EXE. Portable version with no installation: download the file and run it. Move with arrow keys or WASD, place bombs with Space, pause with Esc and enter fullscreen with F11.\n\nNew: more varied retro music with longer melodies, a second voice and changing accompaniment. The wizard in Settings → Controls guides you through all six keys; Esc discards unfinished changes. Individual keys can still be changed separately.\n\nImproved QHD and 4K display, gentler reinforcements after the timer expires and an option to quit from the menu. Scanlines are off by default and can be enabled in settings.\n\nThis release is not digitally signed yet. Windows may show a warning or block the app when it starts.","link":"/binaries/bomberman-2.0.6/BomberMan-2.0.6-portable.exe","icon_url":"/icons/bomberman-2.0.5.png","screenshots":["/screenshots/bomberman-2.0.5/gameplay.png","/screenshots/bomberman-2.0.5/menu.png"],"sort":-2},
