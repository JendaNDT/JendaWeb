...
window.APPS_DATA = [
  ...
  {"id":29,"name":"Fyzika pastelkou","platform":"Android","color":"#527dc4","cs":"Kresli a objevuj fyziku: mechanika, elektrické obvody, voda a olej. Výběr úloh přes celou obrazovku, větší ovládání pro tablety a názorné ukázky nástrojů. Aplikace je česky a funguje offline, bez účtu a reklam.\n\nVerze 0.1.8 doplňuje konkrétní pomoc v osmi atlasových úlohách: po opakovaném prázdném pokusu nabídne první krok s cestou nebo závažím. Po použití příslušné pastelky už tuto radu neopakuje. Obsahuje také dřívější opravy klávesnice, návazných úloh, TalkBacku a čitelnosti.\n\nNově: návrat k rozpracovaným pokusům, přehledný učitelský editor, vlastní mechanické i elektrické úlohy a předávání kapitol dětem. Učitel připraví ověřenou verzi, dítě ji najde mezi vlastními úlohami.\n\nVerze 0.1.8-android.10 · APK 12,6 MB · Android 9+, ARM64 a Vulkan. Alfa obsahuje 152 misí ve 12 kapitolách; 85 nových definic zatím čeká na ověření hratelnosti a může vyžadovat opravy. Nové prostředí bylo ověřované na Macu a Android emulátoru; fyzický tablet a zkoušení s dětmi ještě čekají.\n\nAktualizaci nainstaluj přes stávající aplikaci bez odinstalování. Při první instalaci otevři APK ve správci souborů a na výzvu povol instalaci. Polohu panelu vybereš přes Menu → Pro dospělé → Poloha ovládání. Editor je ve stejné dospělé části menu.","en":"Draw and explore physics: mechanics, electrical circuits, water and oil. A full-screen mission picker, larger tablet controls and visual tool tutorials. The app is in Czech and works offline, without accounts or ads.\n\nVersion 0.1.8 adds specific help to eight Atlas tasks: after repeated empty attempts, it offers a first step with a path or weight. Once the relevant crayon is used, it no longer suggests that it was missing. It also includes the earlier keyboard, related-task, TalkBack and readability fixes.\n\nNew: resume prepared experiments, a clearer teacher editor, custom mechanical and electrical tasks, and portable chapters for children. Teachers prepare a verified playable version; children find it among their own tasks.\n\nVersion 0.1.8-android.10 · 12.6 MB APK · Android 9+, ARM64 and Vulkan. This alpha includes 152 missions in 12 chapters; 85 new definitions still await gameplay verification and may need fixes. The new interface has been checked on Mac and in an Android emulator; physical tablet and child sessions remain pending.\n\nInstall over the existing app without uninstalling. For a first installation, open the APK in a file manager and allow installation when prompted. Choose the toolbar position through Menu → Pro dospělé → Poloha ovládání. The teacher editor is in the same adult section.","link":"/binaries/fyzika-pastelkou-0.1.8-android.10/Fyzika-pastelkou-0.1.8-android.10.apk","icon_url":"/icons/fyzika-pastelkou.png","screenshots":["/screenshots/fyzika-pastelkou-0.1.3/android-missions.png","/screenshots/fyzika-pastelkou-0.1.3/android-play.png","/screenshots/fyzika-pastelkou-0.1.3/android-editor.png","/screenshots/fyzika-pastelkou-0.1.4/android-circuit.png"],"sort":21,"release_stage":"alpha"},
];
