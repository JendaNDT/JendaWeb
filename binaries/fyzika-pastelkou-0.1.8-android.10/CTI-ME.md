...
Verze 0.1.8 doplňuje konkrétní pomoc po prázdném pokusu v osmi atlasových
úlohách. Po opakovaném pokusu nabídne první krok s cestou nebo závažím.
Dosavadní ovládání klávesnice a tabletové prostředí zůstávají.

Balíček `Fyzika-pastelkou-0.1.8-android.10.apk` je alfa pro Android tablety
