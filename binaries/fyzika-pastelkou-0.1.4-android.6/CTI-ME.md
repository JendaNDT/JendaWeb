...
Balíček `Fyzika-pastelkou-0.1.4-android.6.apk` je alfa pro Android tablety
...
Verze 0.1.4 vrací čitelné příklady do prázdných textových polí,
zvyšuje kontrast zelených sdělení a zachovává větší písmo editoru.
