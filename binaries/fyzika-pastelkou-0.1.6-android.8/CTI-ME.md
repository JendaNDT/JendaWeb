...
Balíček `Fyzika-pastelkou-0.1.6-android.8.apk` je alfa pro Android tablety
...
Verze 0.1.6 nabízí při výběru navazující úlohy vlastní úlohy jako první
a ukazuje jejich název. Pokud smazání brání vazba z jiné úlohy, vysvětlí
česky, co je potřeba nejdříve upravit. Obsahuje také jasné **Zpět ke hraní**,
opravy TalkBacku, čitelnosti a většího písma z předchozích verzí.
